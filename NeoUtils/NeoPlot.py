...
def _plot_single_spike_train(spk, color = None, timeunit=q.ms, linestyle="--"):
    '''
    Old functions, don't use. Plots spiketrain
    ...
    for m in spk.times:
        ...
        plt.axvline(x, linestyle=linestyle, color = color)

def _plot_single_analog_signal(signal, color=None, plotlabel = False, timeunit = q.ms, valunit = None):
    '''
    Old function, don't use. Plots analogsignal. Doesn't take into account scales of analogsignals.
    :param signal: neo.AnalogSignal
    :param color: str
    :param plotlabel: str
    :param timeunit: quantities.Quantity
    :param valunit: str
    :return: None
    '''
...
def plot_single_analog_signal(signal):
    '''
    Plots analogsignal and displays it
    :param signal: neo.AnalogSignal
    :return: None
    '''
