...
import BrianUtils.Simulator
import NixUtils.ModelfittingIO
import NeoUtils.NeoPlot
from BrianUtils import NeuronModels as NM
from NeoUtils import Signals as sg

blk = NixUtils.ModelfittingIO.ReadExperiment("130322-1LY")
...
model = NM.AdEx()
simul = BrianUtils.Simulator.Simulator(model)
...
NeoUtils.NeoPlot.PlotSets(res, spikes)